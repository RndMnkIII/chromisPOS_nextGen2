...
public abstract class JPaymentSelect extends javax.swing.JDialog
    ...
    private void initComponents() {
        ...
        jPanel7.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Factura:", 0, 0, new java.awt.Font("Arial", 1, 14))); // NOI18N
...
//            ((JPaymentInterface) m_jTabPayment.getSelectedComponent()).activate(customerext, m_dTotal - m_aPaymentInfo.getTotal(), m_sTransactionID);
    ...
    private void m_jButtonOKActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_m_jButtonOKActionPerformed
        //si es de tipo factura normal y no se ha cumplimentado valor numero de factura mostrar mensaje error
        if(!isSimpleInvoiceSelected() &&(jTextField1.getText().equals("") || !getInvoiceNumber().matches("\\d+"))){
            JOptionPane.showMessageDialog(null, "Falta numero de factura o no es un valor numérico", "Error Numero de Factura",JOptionPane.ERROR_MESSAGE);
            return;
        }
