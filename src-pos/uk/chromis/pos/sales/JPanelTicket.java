...
// Kidsgrove here the payment has been confirmed lets save voucher details into database vCode10V0061
                            ...
                            if(paymentdialog.isPrintSelected() && ticket.getProperty("tipo_factura").equals("normal")){
                                printReport("/uk/chromis/reports/Factura_TPV", ticket, null);
                            }
                             if(paymentdialog.isPrintSelected() && ticket.getProperty("tipo_factura").equals("simplificada")){
