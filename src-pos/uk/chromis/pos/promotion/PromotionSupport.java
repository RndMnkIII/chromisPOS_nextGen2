...
public class PromotionSupport {
    ...
    public void DiscountProductPercent(TicketInfo ticket, int lineIndex,
        ...
        if (productline.isPromotionAdded() == false
            ...
            BigDecimal priceBD=BigDecimal.valueOf(productline.getPrice()).setScale(8,RoundingMode.HALF_UP);
            BigDecimal discountrateBD=BigDecimal.valueOf(discountrate).setScale(8,RoundingMode.HALF_UP);
            BigDecimal factorBD=BigDecimal.valueOf(-100.0).setScale(8,RoundingMode.HALF_UP);
            
            BigDecimal discountBD=priceBD.multiply(discountrateBD).setScale(8,RoundingMode.HALF_UP);discountBD=discountBD.divide(factorBD, 8, RoundingMode.HALF_UP);
            
            
            
            System.out.println("*** Promotion: "+discountBD.doubleValue()+ " Redondeado: " + discountBD.setScale(2,RoundingMode.HALF_UP).doubleValue());
            TicketLineInfo discountline = new TicketLineInfo(
                    ...
                    discountBD.setScale(2,RoundingMode.HALF_UP).doubleValue(),
    ...
    public void DiscountProductQty(TicketInfo ticket, int lineIndex,
        ...
        if (productline.isPromotionAdded() == false
            ...
            Double setPrice;
            Double setQty;
            //BigDecimal setPriceBD;
            //BigDecimal setQtyBD=new BigDecimal(String.valueOf(qty)).setScale(8,RoundingMode.HALF_UP);
            ...
            setPrice=discountBD.setScale(8,RoundingMode.HALF_UP).doubleValue();
