...
public class TicketTaxInfo {
    ...
    public TicketTaxInfo(TaxInfo tax) {
        ...
        //subtotal = 0.0;
        //taxtotal = 0.0;
        subtotalBD =BigDecimal.valueOf(0.0).setScale(8,RoundingMode.HALF_UP);
        taxtotalBD = BigDecimal.valueOf(0.0).setScale(8,RoundingMode.HALF_UP);
    }
    ...
    public void add(double dValue) {
        ...
        BigDecimal dValueBD=BigDecimal.valueOf(dValue).setScale(8,RoundingMode.HALF_UP);
    ...
    public double getSubTotal() {    
        ...
        return subtotalBD.setScale(2,RoundingMode.HALF_UP).doubleValue();
    }
    ...
    public double getTax() {       
        //return taxtotal;
        return taxtotalBD.setScale(2,RoundingMode.HALF_UP).doubleValue();
    }
    ...
    public double getTotal() {         
        ...
        return subtotalBD.add(taxtotalBD).setScale(2,RoundingMode.HALF_UP).doubleValue();
